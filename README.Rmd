...
At the moment, only XML data are supported, which requires SoftMax Pro version 6 or 7.
...
**Help:** I only have access to data produced by one machine and one version of SoftMax Pro, so any feedback is really apprecaited.
